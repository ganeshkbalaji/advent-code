require 'rspec'
require_relative('../main/number_room.rb')
...
RSpec.describe "day 4 - part one - security through obscurity" do
  it "can sum their sector ids" do
    room_number = NumberRoom.new
  ...
  it "can solve the puzzle" do
    ...
    File.readlines(__dir__ + '/input_puzzle.txt')
